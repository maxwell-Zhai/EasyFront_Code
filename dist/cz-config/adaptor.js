...
const cz_config_1 = require("./cz-config");
const config = commitizen_1.configLoader.load() || {};
const options = {
    types: config.types || cz_config_1.types,
...
const prompter = (cz, commit) => {
    ...
    cz.prompt([
        ...
        const body = answers.body ? (0, word_wrap_1.default)(answers.body, wrapOptions) : false;
        ...
        const issues = answers.issues ? (0, word_wrap_1.default)(answers.issues, wrapOptions) : false;
